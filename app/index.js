  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.pageText}>
        Enjoy a weekly selection of our favourite pies
      </Text>
      <View style={styles.pieRow}>
        <PieDisplay prodId="CP-01" pieImage={pieA} product="classic apple pie" />
        <PieDisplay prodId="CP-02" pieImage={pieB} product="pumpkin pie" />
      </View>
    </View>
  );
};
