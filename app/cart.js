  ...
  const CartItem = ({ cartId, productName, productPrice }) => {
    ...
    return (
      <View style={styles.ctItem}>
        ...
        <Button onPress={itemRemove} title="REMOVE" color="#de0909" />
      </View>
    );
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonRow}>
        <Button onPress={cancelOrder} title="CANCEL ORDER" color="#de0909" />
        <Button onPress={processOrder} title="PLACE ORDER" color="#1ed662" />
      </View>
      <FlatList
        data={cartItems}
